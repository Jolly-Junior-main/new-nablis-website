...
replacement = '''<div class="nav-right" style="display:flex; align-items:center; gap: 12px;">
    <!-- Language Dropdown -->
...
for file in glob.glob('*.html'):
    ...
    content = re.sub(r'<div class="nav-right" style="display:flex; align-items:center; gap: 12px;">.*?<a href="quote\.html" class="btn-brand">Request a Quote</a>', replacement, content, flags=re.DOTALL)
